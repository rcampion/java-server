...
/**
 * Custom exception class for Application errors.  This exception type allows an error
 * message key to be passed back to the front end for display to the user.
 */
public class AppException extends Exception {

	private final AppMessage wikiMessage;
	 ...
	 */
	public AppException(AppMessage wikiMessage) {
		super();
	 ...
	 */
	public AppException(AppMessage wikiMessage, Throwable t) {
		super(t);
		this.wikiMessage = wikiMessage;
	}
	 ...
	 */
	public AppMessage getWikiMessage() {
